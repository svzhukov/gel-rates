...
//    }
    ...
    private func chartContent(items: [RatesChartDisplayItem]) -> some View {
        Chart {
    ...
    private func linearGradient(_ items: [RatesChartDisplayItem]) -> LinearGradient {
        LinearGradient(
    ...
    private func addDelayedPointMarks(_ items: [RatesChartDisplayItem], delay: Double) {
    ...
    private func gradientEndYPoint(_ items: [RatesChartDisplayItem]) -> Double {
...
struct ChartAreaContent: ChartContent {
    let item: RatesChartDisplayItem
    init(_ item: RatesChartDisplayItem) {
        self.item = item
    }
